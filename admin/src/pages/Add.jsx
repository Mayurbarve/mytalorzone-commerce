...
const ADD = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-3/4 items-start gap-3'>
      <div>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e) => setName(e.target.value)} value={name} className='w-full max-w-[500pc] px-3 py-2' type="text" placeholder='Type here' required />
      </div>
      <div className='w-full'>
        <p className='mb-2'>Product description</p>
        <input onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500pc] px-3 py-2' type="text" placeholder='Write content here' required />
      </div>

      <div className='flex felx-col sm:flex-row gap-2 w-full sm:gap-8 justify-between'>
        <div>
        ...
        <div>
          ...
          <select onChange={(e) => setSubcategory(e.target.value)} className='w-full px-3 py-2 '>
            ...
            <option value="BanarasiTraditional">Banarasi</option>
            <option value="Traditional">Traditional</option>
            <option value="StraightFit">Straight Fit</option>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='21' />
        </div>
